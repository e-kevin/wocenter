        ...
        <div class="active tab-pane" id="avatar">
            ...
            $column = [
                [
                    ...
                    'attribute' => 'id',
                    'format' => 'raw',
                    'value' => function ($model) use ($app) {
                        return $model['infoInstance']->canInstall
                            ? $model['id']
                            : Html::a($model['id'], ['update', 'id' => $model['id'], 'app' => $app], ['data-pjax' => 1]);
                    },
                ],
                [
                    'attribute' => 'name',
                ...
                [
                    ...
                    'value' => function ($model) use ($runModuleList) {
                        switch ($model['run_module']) {
                            case \wocenter\backend\modules\modularity\models\Module::RUN_MODULE_CORE:
                                return '<span class="text-danger">' . $runModuleList[$model['run_module']] . '</span>';
                                break;
                            case \wocenter\backend\modules\modularity\models\Module::RUN_MODULE_DEVELOPER:
