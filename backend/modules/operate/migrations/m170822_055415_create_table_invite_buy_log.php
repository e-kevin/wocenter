...
class m170822_055415_create_table_invite_buy_log extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%invite_buy_log}}', [
        ...
        $this->addForeignKey('fk-invite_buy_log-uid', '{{%invite_buy_log}}', 'uid', '{{%user}}', 'id','CASCADE');
        $this->addForeignKey('fk-invite_buy_log-invite_type', '{{%invite_buy_log}}', 'invite_type', '{{%invite_type}}', 'id','CASCADE');
