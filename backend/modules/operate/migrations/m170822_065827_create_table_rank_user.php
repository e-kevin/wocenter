...
class m170822_065827_create_table_rank_user extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey('fk-rank_user-uid', '{{%rank_user}}', 'uid', '{{%user}}', 'id', 'CASCADE');
        $this->addForeignKey('fk-rank_user-rank_id', '{{%rank_user}}', 'rank_id', '{{%rank}}', 'id', 'CASCADE');
