...
class m170822_054703_create_table_invite extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%invite}}', [
            ...
            'already_num' => $this->integer(10)->unsigned()->notNull()->comment('已经注册用户（含升级）'),
        ...
        $this->addForeignKey('fk-invite-invite_type', '{{%invite}}', 'invite_type', '{{%invite_type}}', 'id', 'CASCADE');
        $this->addForeignKey('fk-invite-uid', '{{%invite}}', 'uid', '{{%user}}', 'id', 'CASCADE');
