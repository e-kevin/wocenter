...
use wocenter\models\User as baseUser;
use Yii;
 ...
 * @property \wocenter\backend\modules\log\models\UserScoreLog[] $userScoreLogs
 */
class User extends baseUser
{
    ...
    {
        return $this->hasMany(\wocenter\backend\modules\log\models\UserScoreLog::className(), ['uid' => 'id']);
    }
