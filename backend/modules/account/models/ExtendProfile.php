...
/**
 * This is the model class for table "{{%extend_profile}}".
 *
 * @property integer $id
...
class ExtendProfile extends ActiveRecord
{
    ...
    {
        return $this->hasMany(Identity::className(), ['id' => 'identity_id'])->viaTable('{{%identity_profile}}', ['profile_id' => 'id']);
    }
