...
class m170822_052401_create_table_identity_config extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%identity_config}}', [
        ...
        $this->batchInsert('{{%identity_config}}', ['id', 'identity_id', 'name', 'category', 'value', 'updated_at'], [
            [1, 1, 'profile', '', '1,2,3,4', 1499840417],
            [2, 1, 'signup', '', '1,2,3,4', 1499840426],
            [3, 1, 'score', '', '{"score_1":"0","score_2":"0","score_3":"0","score_4":"0"}', 1500171452],
        ]);

        $this->addForeignKey('fk-identity_config-identity_id', '{{%identity_config}}', 'identity_id', '{{%identity}}', 'id', 'CASCADE');
    ...
    {
        $this->dropTable('{{%identity_config}}');
    }
