...
class m170822_032102_create_table_extend_field_setting extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%extend_field_setting}}', [
        ...
        $this->batchInsert('{{%extend_field_setting}}', [
        ...
        $this->addForeignKey('fk-extend_field_setting-profile_id', '{{%extend_field_setting}}', 'profile_id', '{{%extend_profile}}', 'id', 'CASCADE');
    ...
    {
        $this->dropTable('{{%extend_field_setting}}');
    }
