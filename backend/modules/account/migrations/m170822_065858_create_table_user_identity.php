...
class m170822_065858_create_table_user_identity extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey('fk-user_identity-uid', '{{%user_identity}}', 'uid', '{{%user}}', 'id', 'CASCADE');
        $this->addForeignKey('fk-user_identity-identity_id', '{{%user_identity}}', 'identity_id', '{{%identity}}', 'id', 'CASCADE');
