...
class m170822_065816_create_table_notify_node extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->batchInsert('{{%notify_node}}', ['id', 'node', 'name', 'description', 'content_key', 'name_key', 'email_sender', 'send_message', 'sender'], [
